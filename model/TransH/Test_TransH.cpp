...
class Test{
    vector<vector<double> > relation_vec,entity_vec,A;
    vector<int> h,l,r;
...
void prepare()
{
    FILE* f1 = fopen("../data/SSP/entity2id.txt","r");
	FILE* f2 = fopen("../data/SSP/relation2id.txt","r");
	int x;
    ...
    FILE* f_kb = fopen("../data/SSP/test.txt","r");
    ...
    fclose(f_kb);
    FILE* f_kb1 = fopen("../data/SSP/train.txt","r");
    ...
    fclose(f_kb1);
    FILE* f_kb2 = fopen("../data/SSP/valid.txt","r");
