$(function() {
	...
	layui.table.render({
		...
		cols: [[
			{type:'numbers'},
			{field:'hid', sort: true, title: '头实体'},
			{field:'rid', sort: true, title: '关系'},
			{field:'tid', sort: true, title: '尾实体'},
	...
	layui.form.on('submit(btnSubmit)', function(data) {
		...
		layer.load(1);
		$.post("api/triple", data.field, function(data){
